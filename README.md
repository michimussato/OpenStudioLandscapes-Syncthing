...
The following variables are being declared in `OpenStudioLandscapes.Syncthing.constants` and are accessible throughout the [`OpenStudioLandscapes-Syncthing`](https://github.com/michimussato/OpenStudioLandscapes-Syncthing/tree/main/src/OpenStudioLandscapes/Syncthing/constants.py) package.

| Variable                            | Type   |
| :---------------------------------- | :----- |
| `DOCKER_USE_CACHE`                  | `bool` |
| `SYNCTHING_CONFIG_INSIDE_CONTAINER` | `bool` |
| `ASSET_HEADER`                      | `dict` |
