<!-- TOC -->
* [OpenStudioLandscapes-Syncthing](#openstudiolandscapes-syncthing)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/Syncthing/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/Syncthing/_definitions_with_upstream_specs.py) 
which also contains 
